// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
// FileName:     webMain.cpp
// Author:       dingfang
// CreateDate:   2020-10-30 21:25:37
// ModifyAuthor: dingfang
// ModifyDate:   2020-10-31 11:11:51
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
int init(int argc, char **argv)
{
    json conf;
    string logfile;
    logfile = argc == 2 ? argv[1] :  "../conf/dfsrr-http-server.json";

    if (!parseConfig(logfile, conf))
    {
        printf("parse config error, file: [%s]\n", logfile.c_str());
        exit(-1);
    }
    ...
    LOG(INFO, "dfssr web server is running...");
